...
public class BasePage extends AbstractPage {
    ...
    @FindBy(xpath = "//a[(@href='/Karynageek/academylessons-flow')]")
    private WebElement repositoryFlowLinks;
    ...
    @FindBy(xpath = "//div[@id='dashboard-repos-container']//button")
    ...
    public RepositoryPage clickOnShowMoreLink() {
        showMoreLink.click();
        return new RepositoryPage(webDriver);
    }
    ...
    public RepositoryPage goToAcademyLessonsFlowRepositoryLink() {
        repositoryFlowLinks.click();
        return new RepositoryPage(webDriver);
    }
